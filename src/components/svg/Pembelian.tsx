...
const Pembelian = (props: SvgProps) => (
  <Svg width={52} height={52} fill="none">
    <G clipPath="url(#a)">
      ...
      <Path
        fill="#fff"
        d="M30.958 38.25a2.042 2.042 0 1 0 0-4.084 2.042 2.042 0 0 0 0 4.083ZM21.625 38.25a2.042 2.042 0 1 0 0-4.084 2.042 2.042 0 0 0 0 4.083ZM17.647 16.597l-.234 2.859a.925.925 0 0 0 .934 1.003h17.861c.49 0 .899-.373.934-.863.151-2.065-1.424-3.745-3.489-3.745H19.315a3.18 3.18 0 0 0-.712-1.412 3.103 3.103 0 0 0-2.24-.98h-2.03a.881.881 0 0 0-.875.875c0 .478.397.875.875.875h2.03c.362 0 .7.152.945.408.245.269.362.619.339.98ZM35.928 22.209H18.032a.938.938 0 0 0-.934.852l-.42 5.075a3.41 3.41 0 0 0 3.395 3.698h12.974c1.75 0 3.29-1.435 3.418-3.185l.385-5.448a.913.913 0 0 0-.922-.992Z"
      />
    </G>
    <Defs>
      <LinearGradient
